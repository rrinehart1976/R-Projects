...
sales_data_tbl <- tibble(
  date  = seq.Date(from = ymd("2020-01-01"), to = today(), length.out = 90),
...
output$slider_input_values <- renderPrint(input$slider_input)

textOutput(outputId = "slider_input_values")
```
